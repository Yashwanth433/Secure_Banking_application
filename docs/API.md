...
## Base URL
- Development: `https://banking-application-ieks.onrender.com/api`
...
const api = axios.create({
  baseURL: 'https://banking-application-ieks.onrender.com/api',
  headers: {
    'Authorization': `Bearer ${token}`
  }
});
...
```bash
# Login
curl -X POST https://banking-application-ieks.onrender.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"user@example.com","password":"password123"}'

# Get accounts
curl -X GET https://banking-application-ieks.onrender.com/api/accounts \
  -H "Authorization: Bearer your-jwt-token"

# Transfer money
curl -X POST https://banking-application-ieks.onrender.com/api/transactions/transfer \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer your-jwt-token" \
